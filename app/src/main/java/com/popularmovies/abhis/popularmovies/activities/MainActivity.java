...
public abstract class MainActivity extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<LiveData<MovieData>> {
    ...
    private void showFavorites() {
        movieAdapter = new MovieAdapter(MainActivity.this, movieDatabase.moviesDao().getAllMovies());
        ...
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET, url, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    movieAdapter = new MovieAdapter(MainActivity.this, (LiveData<MovieData>) movieList);
                    mRecyclerView.setAdapter(movieAdapter);
                    movieAdapter.notifyDataSetChanged();
    ...
    public Loader<LiveData<MovieData>> onCreateLoader(int i, final Bundle bundle) {
        ...
        return new AsyncTaskLoader<LiveData<MovieData>>(this) {
            ...
            public LiveData<MovieData> loadInBackground() {
                if(Constants.FAVORITES.equals(currentOrder)){

                    return (LiveData<MovieData>) movieDatabase.moviesDao().getAllMovies();

                }
                return (LiveData<MovieData>) getMovies(buildURL(currentOrder));
            }
        };
    }
