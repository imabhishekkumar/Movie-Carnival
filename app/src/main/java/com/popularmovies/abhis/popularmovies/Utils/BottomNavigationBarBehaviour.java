...
public class BottomNavigationBarBehaviour extends CoordinatorLayout.Behavior<BottomNavigationView> {

    public BottomNavigationBarBehaviour() {
        super();
    }

    public BottomNavigationBarBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
