...
public final class MovieRecylerView extends RecyclerView {

    private static final String SAVED_SUPER_STATE = "super-state";
    private static final String SAVED_LAYOUT_MANAGER = "layout-manager-state";
    private Parcelable mLayoutManagerSavedState;

    public MovieRecylerView(Context context) {
        super(context);
    }

    public MovieRecylerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MovieRecylerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
